...
class Meetserie
{
  ...
  public:
    ...
    */
    ...
    int getMeetwaarde(int i) const;
    /* pre :  0<=i<aantal meetwaarden
       post:  return i-de meetwaarde
    */

    void bepAantalMeetwaarden(int &aantal) const;
    /* pre : -
    ...
    */
    ...
    void save();
    /* pre:
       post: bestand met meetserie in meetserie.txt
       */

    static Meetserie load();
    /* pre: bestand met meetserie in meetserie.txt
    post: Meetserie vanuit bestand aangemaakt */
};
