...
void showMenu( void )
{
	...
	cout << ("\n[10] Tonen van aantal verschillende waarden");
	cout << ("\n[11] Tonen hoe vaak een bepaalde meetwaarde voorkomt");
	cout << ("\n[12] Opslaan dummy meetserie (test)");
	cout << ("\n[13] Laden dummy meetserie (test)");
	cout << ("\n[14] Opslaan huidige meetserieextra");
	cout << ("\n[15] Laden huidige meetserieextra");
	cout << ("\n[16] STOPPEN");
	cout <<  ("\n\nKeuze : ");
}
